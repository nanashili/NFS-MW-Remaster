...
internal class CommandScript : IRunCommand
{
    public void Execute(ExecutionResult result)
    {
        ...
        try {
            ...
            File.WriteAllBytes("Art/RockportGround/unity-painted-terrain-downtown.png",image.EncodeToPNG());
            camera.transform.position=new Vector3(-1730,8700,950);camera.transform.LookAt(new Vector3(-1730,150,-2100));camera.orthographicSize=3800;
            ...
            File.WriteAllBytes("Art/RockportGround/unity-painted-terrain-overview.png",image.EncodeToPNG());result.Log("Saved HDRP combined map renders.");
        } finally {
