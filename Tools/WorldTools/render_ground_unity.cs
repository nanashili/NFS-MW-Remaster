...
internal class CommandScript : IRunCommand
{
    public void Execute(ExecutionResult result)
    {
        ...
        try {
            ...
            File.WriteAllBytes("Art/RockportGround/unity-downtown.png",image.EncodeToPNG());
            ...
            File.WriteAllBytes("Art/RockportGround/unity-overview.png",image.EncodeToPNG());result.Log("Saved HDRP combined map renders.");
        } finally {
