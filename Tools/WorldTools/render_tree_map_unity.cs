...
internal class CommandScript : IRunCommand
{
    public void Execute(ExecutionResult result)
    {
        ...
        try {
            ...
            File.WriteAllBytes("Art/RockportTrees/unity-trees-downtown.png",image.EncodeToPNG());
            ...
            File.WriteAllBytes("Art/RockportTrees/unity-trees-overview.png",image.EncodeToPNG());result.Log("Saved HDRP combined map renders.");
        } finally {
